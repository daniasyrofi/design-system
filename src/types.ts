...
// Badge
export type BadgeVariant = 'neutral' | 'primary' | 'danger' | 'success' | 'warning' | 'info' | 'secondary'
export type BadgeSize    = 'sm' | 'md' | 'lg'
export type BadgeStyle   = 'subtle' | 'solid' | 'outline'

// Button
export type ButtonVariant = 'default' | 'primary' | 'secondary' | 'outline' | 'ghost' | 'danger' | 'link'

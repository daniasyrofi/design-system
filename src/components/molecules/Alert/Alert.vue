...
> = {
  sm: {
    ...
    iconRadius: '8px',
    iconPx: 13,
    titleStyle: 'font-size:13px;font-weight:600;line-height:1rem;letter-spacing:-0.01em;',
    bodyStyle: 'font-size:12px;line-height:1rem;',
    closeSize: 14,
  },
  md: {
    p: '1rem',
    ...
    iconRadius: '10px',
    iconPx: 16,
    titleStyle: 'font-size:14px;font-weight:600;line-height:1.25rem;letter-spacing:-0.01em;',
    bodyStyle: 'font-size:13px;line-height:1.25rem;',
    closeSize: 15,
  },
  lg: {
    p: '1rem 1.25rem',
    ...
    iconRadius: '11px',
    iconPx: 18,
    titleStyle: 'font-size:15px;font-weight:600;line-height:1.25rem;letter-spacing:-0.01em;',
    bodyStyle: 'font-size:14px;line-height:1.25rem;',
    closeSize: 16,
  },
}
